...
CREATE TABLE `Method` (
  ...
  `type` varchar(50) NOT NULL DEFAULT 'Object' COMMENT '返回值类型。TODO RemoteMethod 校验 type 和 back',
...
-- Dump completed on 2019-12-01 23:16:09
