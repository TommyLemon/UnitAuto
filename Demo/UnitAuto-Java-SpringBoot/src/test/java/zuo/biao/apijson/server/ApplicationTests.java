...
import apijson.demo.server.MathUtil;
...
public class ApplicationTests {
	...
	public void divide0() {
		...
		double d = MathUtil.divide(a, b);  //执行方法并返回实际值，对应 UnitAuto 执行的结果 { "invoke": 0.5, "instance": null ... }
	...
	public void divide1() {
		...
		double d = MathUtil.divide(a, b);  //执行方法并返回实际值，对应 UnitAuto 执行的结果 { "invoke": -4, "instance": null ... }
