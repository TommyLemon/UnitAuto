    ...
    if (value == null || value instanceof Object) {
      switch (key) {
        ...
        case 'classArgs':
          ...
          //   return ' ! value必须是JSONArray类型！且必须符合 [ { "type": "Integer", "value": 1 } ] 这种结构！type 省略时会根据 value 自动判断。';
          // }
          // if (CodeUtil.getType4Request(value[0]) != 'object') {
          //   return ' ! value中每一项都必须是JSONObject类型！且必须符合 [ { "type": "Integer", "value": 1 } ] 这种结构！type 省略时会根据 value 自动判断。';
          // }
